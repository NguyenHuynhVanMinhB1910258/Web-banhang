            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="admin/firms-show">Nhà cung cấp</a>
                        <a class="collapse-item" href="admin/orders-show">Đơn Hàng</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a href="admin/add_product" class="collapse-item btn" style="font-size: 13px; text-align: left">Thêm sản phẩm mới</a>
                        <a href="admin/products-show" class="collapse-item btn" style="font-size: 13px; text-align: left">Xem tất cả sản phẩm</a>
                    </div>
                </div>
            </li>
